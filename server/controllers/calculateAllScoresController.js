...
const calculateTotalScore = (applicant, solicitudReemplazo) => {
  ...
  // Comparar "yearsExperience" del solicitante con el de la solicitud de reemplazo
  if (applicant.yearsExperience < solicitudReemplazo.yearsExperience) {
    totalScore += 5; // Otorgar 5 puntos si los años de experiencia del solicitante son menores.
  } else if (applicant.yearsExperience === solicitudReemplazo.yearsExperience) {
    totalScore += 10; // Otorgar 10 puntos si los años de experiencia del solicitante son iguales a los de la solicitud.
  } else {
    totalScore += 15; // Otorgar 15 puntos si los años de experiencia del solicitante son mayores que los de la solicitud.
  }
